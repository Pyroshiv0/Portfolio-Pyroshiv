...
public class StitchedMusclesItem extends Item {
	public StitchedMusclesItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Twice as Strong!"));
		list.add(Component.literal("Two lungs,two ribs"));
