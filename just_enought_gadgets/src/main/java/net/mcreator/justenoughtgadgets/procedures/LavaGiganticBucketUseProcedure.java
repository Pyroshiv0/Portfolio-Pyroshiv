...
public class LavaGiganticBucketUseProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Direction direction, Entity entity, ItemStack itemstack) {
        ...
        if (direction == null || entity == null)
            return;
        if (direction == Direction.DOWN && ((world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == Blocks.LAVA || (world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == Blocks.AIR
                    ...
                    for (dz = -2; dz<=2; dz++) {
                        ...
                        if (!(dx == 0 && dy == 0 && dz == 0)) {
                            if (itemstack.getOrCreateTag().getDouble("containing") >0) {
                                ...
                                if (direction == Direction.DOWN && ((world.getBlockState(BlockPos.containing(x+dx, y+dy - 1, z+dz))).getBlock() == Blocks.LAVA || (world.getBlockState(BlockPos.containing(x+dx, y+dy - 1, z+dz))).getBlock() == Blocks.AIR
                                        || (world.getBlockState(BlockPos.containing(x+dx, y+dy - 1, z+dz))).getBlock() == Blocks.CAVE_AIR)) {
                                    world.setBlock(BlockPos.containing(x+dx, y+dy - 1, z+dz), Blocks.LAVA.defaultBlockState(), 3);
                                    itemstack.getOrCreateTag().putDouble("containing", (itemstack.getOrCreateTag().getDouble("containing") - 1));
                                }
                            }
                        }
            ...
            if ((entity instanceof Player _plr ? _plr.getAbilities().instabuild : false)) {
                if (itemstack.getOrCreateTag().getDouble("containing") < 1) {
                    ...
                    if (entity instanceof LivingEntity _entity) {
                        ItemStack _setstack = new ItemStack(JustEnoughtGadgetsModItems.GIGANTIC_BUCKET.get());
        ...
        } else if (direction == Direction.UP && ((world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == Blocks.LAVA|| (world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == Blocks.AIR
                || (world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == Blocks.CAVE_AIR)) {
            if (entity instanceof LivingEntity _entity)
                _entity.swing(InteractionHand.MAIN_HAND, true);
            world.setBlock(BlockPos.containing(x, y + 1, z), Blocks.LAVA.defaultBlockState(), 3);
            ...
            for (dx = -2; dx<=2; dx++) {
                for (dy = -2; dy<=2; dy++) {
                    for (dz = -2; dz<=2; dz++) {
                        if (!(dx == 0 && dy == 0 && dz == 0)) {
                            if (itemstack.getOrCreateTag().getDouble("containing") >0) {
                                if (direction == Direction.UP && ((world.getBlockState(BlockPos.containing(x+dx, y+dy + 1, z+dz))).getBlock() == Blocks.LAVA || (world.getBlockState(BlockPos.containing(x+dx, y+dy + 1, z+dz))).getBlock() == Blocks.AIR
                                        || (world.getBlockState(BlockPos.containing(x+dx, y+dy + 1, z+dz))).getBlock() == Blocks.CAVE_AIR )) {
                                    world.setBlock(BlockPos.containing(x+dx, y+dy + 1, z+dz), Blocks.LAVA.defaultBlockState(), 3);
                                    itemstack.getOrCreateTag().putDouble("containing", (itemstack.getOrCreateTag().getDouble("containing") - 1));
                                }
        ...
        } else if (direction == Direction.NORTH && ((world.getBlockState(BlockPos.containing(x, y, z-1))).getBlock() == Blocks.LAVA || (world.getBlockState(BlockPos.containing(x, y , z- 1))).getBlock() == Blocks.AIR
            ...
            for (dx = -2; dx<=2; dx++) {
                for (dy = -2; dy<=2; dy++) {
                    for (dz = -2; dz<=2; dz++) {
                        ...
                        if (!(dx == 0 && dy == 0 && dz == 0)) {
                            if (itemstack.getOrCreateTag().getDouble("containing") >0) {
                                if (direction == Direction.NORTH && ((world.getBlockState(BlockPos.containing(x+dx, y+dy, z+dz-1))).getBlock() == Blocks.LAVA || (world.getBlockState(BlockPos.containing(x+dx, y+dy, z+dz-1))).getBlock() == Blocks.AIR
                                        || (world.getBlockState(BlockPos.containing(x+dx, y+dy, z+dz-1))).getBlock() == Blocks.CAVE_AIR )) {
                                    world.setBlock(BlockPos.containing(x+dx, y+dy, z+dz-1), Blocks.LAVA.defaultBlockState(), 3);
                                    itemstack.getOrCreateTag().putDouble("containing", (itemstack.getOrCreateTag().getDouble("containing") - 1));
                                }
                            }
                        }
        ...
        } else if (direction == Direction.SOUTH && ((world.getBlockState(BlockPos.containing(x, y, z+1))).getBlock() == Blocks.LAVA || (world.getBlockState(BlockPos.containing(x, y , z + 1))).getBlock() == Blocks.AIR
                || (world.getBlockState(BlockPos.containing(x, y , z + 1))).getBlock() == Blocks.CAVE_AIR )) {
            if (entity instanceof LivingEntity _entity)
                _entity.swing(InteractionHand.MAIN_HAND, true);
            world.setBlock(BlockPos.containing(x, y, z + 1), Blocks.LAVA.defaultBlockState(), 3);
            ...
            for (dx = -2; dx<=2; dx++) {
                for (dy = -2; dy<=2; dy++) {
                    for (dz = -2; dz<=2; dz++) {
                        ...
                        if (!(dx == 0 && dy == 0 && dz == 0)) {
                            if (itemstack.getOrCreateTag().getDouble("containing") >0) {
                                if (direction == Direction.SOUTH && ((world.getBlockState(BlockPos.containing(x+dx, y+dy, z+dz+1))).getBlock() == Blocks.LAVA || (world.getBlockState(BlockPos.containing(x+dx, y+dy, z+dz+1))).getBlock() == Blocks.AIR
                                        || (world.getBlockState(BlockPos.containing(x+dx, y+dy, z+dz+1))).getBlock() == Blocks.CAVE_AIR)) {
                                    world.setBlock(BlockPos.containing(x+dx, y+dy, z+dz+1), Blocks.LAVA.defaultBlockState(), 3);
                                    itemstack.getOrCreateTag().putDouble("containing", (itemstack.getOrCreateTag().getDouble("containing") - 1));
                                }
        ...
        } else if (direction == Direction.EAST && ((world.getBlockState(BlockPos.containing(x+1, y, z))).getBlock() == Blocks.LAVA || (world.getBlockState(BlockPos.containing(x+1, y, z))).getBlock() == Blocks.AIR
            ...
            for (dx = -2; dx<=2; dx++) {
                for (dy = -2; dy<=2; dy++) {
                    for (dz = -2; dz<=2; dz++) {
                        ...
                        if (!(dx == 0 && dy == 0 && dz == 0)) {
                            if (itemstack.getOrCreateTag().getDouble("containing") >0) {
                                if (direction == Direction.EAST && ((world.getBlockState(BlockPos.containing(x+dx+1, y+dy, z+dz))).getBlock() == Blocks.LAVA  || (world.getBlockState(BlockPos.containing(x+dx+1, y+dy, z+dz))).getBlock() == Blocks.AIR
                                        || (world.getBlockState(BlockPos.containing(x+dx+1, y+dy, z+dz))).getBlock() == Blocks.CAVE_AIR )) {
                                    world.setBlock(BlockPos.containing(x+dx+1, y+dy, z+dz), Blocks.LAVA.defaultBlockState(), 3);
                                    itemstack.getOrCreateTag().putDouble("containing", (itemstack.getOrCreateTag().getDouble("containing") - 1));
                                }
                            }
                        }
        ...
        } else if (direction == Direction.WEST && ((world.getBlockState(BlockPos.containing(x-1, y, z))).getBlock() == Blocks.LAVA || (world.getBlockState(BlockPos.containing(x-1, y, z))).getBlock() == Blocks.AIR
                || (world.getBlockState(BlockPos.containing(x-1, y, z))).getBlock() == Blocks.CAVE_AIR)) {
            if (entity instanceof LivingEntity _entity)
                _entity.swing(InteractionHand.MAIN_HAND, true);
            world.setBlock(BlockPos.containing(x-1, y, z), Blocks.LAVA.defaultBlockState(), 3);
            ...
            for (dx = -2; dx<=2; dx++) {
                for (dy = -2; dy<=2; dy++) {
                    for (dz = -2; dz<=2; dz++) {
                        ...
                        if (!(dx == 0 && dy == 0 && dz == 0)) {
                            if (itemstack.getOrCreateTag().getDouble("containing") >0) {
                                if (direction == Direction.WEST && ((world.getBlockState(BlockPos.containing(x+dx-1, y+dy, z+dz))).getBlock() == Blocks.LAVA || (world.getBlockState(BlockPos.containing(x+dx-1, y+dy, z+dz))).getBlock() == Blocks.AIR
                                        || (world.getBlockState(BlockPos.containing(x+dx-1, y+dy, z+dz))).getBlock() == Blocks.CAVE_AIR)) {
                                    world.setBlock(BlockPos.containing(x+dx-1, y+dy, z+dz), Blocks.LAVA.defaultBlockState(), 3);
                                    itemstack.getOrCreateTag().putDouble("containing", (itemstack.getOrCreateTag().getDouble("containing") - 1));
                                }
