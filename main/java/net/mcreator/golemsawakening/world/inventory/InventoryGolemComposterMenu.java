...
package net.mcreator.golemsawakening.world.inventory;
...
import net.mcreator.golemsawakening.init.GolemsAwakeningModMenus;

import java.util.function.Supplier;
import java.util.Map;
import java.util.HashMap;

public class InventoryGolemComposterMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public InventoryGolemComposterMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(GolemsAwakeningModMenus.INVENTORY_GOLEM_COMPOSTER.get(), id);
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 151, 26) {
